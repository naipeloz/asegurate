...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      { url: '/favicon-new-16x16.png', sizes: '16x16', type: 'image/png' },
      { url: '/favicon-new-32x32.png', sizes: '32x32', type: 'image/png' },
    ],
...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
})(window,document,'script','dataLayer','GTM-TPZZRVV5');`,
          }}
        />
      ...
      <body className={`${montserrat.variable} ${mukta.variable} antialiased`}>
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-TPZZRVV5"
            height="0"
            width="0"
