      ...
      cards: [
        {
          ...
          desc: 'Orientação especializada para clientes estrangeiros que buscam estruturar seus ativos no Uruguai, com profundo conhecimento do marco legal local e internacional.',
        },
        {
          icon: ICONS.Juridico,
          title: 'Estruturas Legais',
          desc: 'Desenvolvemos as estruturas societárias e de seguros mais adequadas para proteger seu patrimônio dentro do robusto marco jurídico uruguaio.',
        },
        {
          icon: ICONS.Confidencialidad,
          title: 'Máxima Confidencialidade',
          desc: 'Garantimos a total privacidade de suas informações e operações, respaldados pela legislação uruguaia sobre confidencialidade financeira.',
        },
      ],
    },
    why: {
      ...
      cards: [
        {
          icon: ICONS.Juridico,
          title: 'Estabilidade Jurídica',
          desc: 'O Uruguai possui um dos sistemas legais mais sólidos e transparentes da América Latina, oferecendo segurança jurídica incomparável para a proteção patrimonial internacional.',
        },
        {
          icon: ICONS.Confidencialidad,
          title: 'Confidencialidade',
          desc: 'O marco legal uruguaio garante a privacidade das operações financeiras e societárias, protegendo a identidade e os ativos dos nossos clientes internacionais.',
        },
        {
          icon: ICONS.Comercio,
          title: 'Localização Estratégica',
          desc: 'Punta del Este se posiciona como o hub financeiro e de negócios do Cone Sul, com excelente conectividade internacional e uma comunidade de alto poder aquisitivo.',
        },
        {
          icon: ICONS.Exclusividad,
          title: 'Qualidade de Vida',
          desc: 'O Uruguai oferece uma qualidade de vida excepcional com segurança, estabilidade política e uma infraestrutura de primeiro nível para negócios e investimentos internacionais.',
        },
      ],
    },
    cta: {
