...
const content = {
  ...
  pt: {
    nosotros: {
      ...
      body: [
        ...
        'Projetamos estruturas garantidas para respaldar o valor do que foi construído, de maneira a organizar a continuidade do negócio.',
    ...
    benefits: [
      { icon: ICONS.Seguridad, title: 'Capital segurado não penhorável', desc: 'Resguarda o valor da sua empresa ou participações societárias sob uma estrutura desenhada para proteger seu patrimônio.' },
      { icon: ICONS.Exclusividad, title: 'Sem período de carência', desc: 'O respaldo começa desde o início. Uma solução pensada para agir quando o negócio precisa, sem esperas desnecessárias.' },
      { icon: ICONS.Juridico, title: 'Fundo rentável em USD', desc: 'Além de resguardar, o capital vai para um fundo rentável em dólares, combinando respaldo e planejamento.' },
      { icon: ICONS.Innovacion, title: 'Desenho personalizado e confidencial', desc: 'Cada caso é único. Analisamos sua estrutura e objetivos para desenhar uma proposta sob medida, em um processo privado e profissional.' },
    ],
    servicios: {
      h2: 'Serviços',
      subtitle: 'Soluções de Respaldo Patrimonial',
      coverageH3: 'Respaldo Exclusivo',
      coveragePoints: [
        '**Abordagem estratégica e preventiva:** não reagimos ao risco; nós o antecipamos e desenhamos uma estrutura patrimonial.',
        '**Desenho sob medida:** a proposta é montada com base na sua estrutura societária, objetivos e nível de exposição real.',
        '**Confidencialidade e atendimento premium:** avaliação privada, comunicação aberta e acompanhamento personalizado.',
        '**Clareza no processo:** ⁠Reunião de análise estratégica, desenho da estratégia, ⁠Implementação',
        'Dê ao seu patrimônio o respaldo que ele precisa. Agende sua reunião personalizada.',
      ],
    },
    services: [
      { icon: ICONS.Empresa, title: 'Proprietários de empresas e sociedades', desc: 'Desenhamos esquemas de respaldo baseados em um **capital segurado não penhorável**, sem período de carência, que representa o valor total da empresa ou de suas participações societárias. A solução se adapta à estrutura societária e pode contemplar sócios, diretores ou pessoas-chave.' },
      { icon: ICONS.Comercio, title: 'Proprietários de comércios', desc: 'Para negócios onde o funcionamento depende diretamente do proprietário, desenhamos uma estrutura de respaldo orientada à **continuidade operacional:** previsibilidade diante de imprevistos, respaldo do valor construído e um esquema claro para não improvisar quando o comércio precisa de estabilidade.' },
      { icon: ICONS.Innovacion, title: 'Profissionais independentes', desc: 'Respaldamos a cada profissional independente em sua atividade garantindo sua **aposentadoria**.' },
    ],
    faq: { h2: 'Perguntas Frequentes' },
    contacto: {
      h2: 'Contato',
      subtitle: 'Agende sua consulta personalizada',
      formH3: 'Formulário de Contato',
      meetingH3: 'Agende sua reunião personalizada',
      meetingBody: 'Estamos prontos para assessorá-lo!',
  ...
  en: {
    nosotros: {
      h2: 'About Us',
      body: [
        'At ASEGURATE, we are specialists in **strategic asset backing** for business owners, partnerships, shops, and independent professionals.',
        'We design guaranteed structures to back the value of what has been built, thus organizing business continuity.',
      ...
      misionBody: [
        'Our mission is to guarantee the assets of those who build businesses—**owners, partners, merchants, and independent professionals**—anticipating risks with solid, confidential, and sustainable structures.',
    ...
    benefits: [
      ...
      { icon: ICONS.Exclusividad, title: 'No waiting period', desc: 'The backing begins from the start. A solution designed to act when the business needs it, without unnecessary delays.' },
      { icon: ICONS.Juridico, title: 'Profitable fund in USD', desc: 'In addition to backing, the capital goes to a profitable fund in dollars, combining backing and planning.' },
    ...
    servicios: {
      h2: 'Services',
      subtitle: 'Asset Backing Solutions',
      ...
      coveragePoints: [
        ...
        '**Confidentiality and premium service:** private evaluation, open communication, and personalized accompaniment.',
        '**Clear process:** ⁠Strategic analysis meeting, strategy design, ⁠Implementation',
        'Give your assets the backing they need. Schedule your personalized meeting.',
      ],
    },
    services: [
      ...
      { icon: ICONS.Comercio, title: 'Shop owners', desc: 'For businesses where operation directly depends on the owner, we design a backing structure oriented towards **operational continuity:** predictability in the face of unforeseen events, backing of the built value, and a clear scheme to avoid improvising when the business needs stability.' },
      { icon: ICONS.Innovacion, title: 'Independent professionals', desc: 'We back every independent professional in their activity, guaranteeing their **retirement**.' },
    ],
    faq: { h2: 'Frequently Asked Questions' },
    contacto: {
      h2: 'Contact',
      subtitle: 'Schedule your personalized consultation',
      formH3: 'Contact Form',
      meetingH3: 'Schedule your personalized meeting',
      meetingBody: 'We are ready to advise you!',
